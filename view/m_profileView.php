...
<table>
	...
	<tr>
		<td>
			<form id="file-form" method="post" enctype="multipart/form-data">
				<label for="fileToUpload">Modify account foto</label>
				<input style="display: none" type="file" name="fileToUpload" id="fileToUpload" accept="image/*" onchange="fileName()">
				<span id="file_name"></span>
				</br>
				<input type="submit" style="width:140px" value="Submit" name="Modifier">
			</form>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td id="col1"></td>
		<td><input id="submit_form" type="submit" name="submit" onclick="modify_profile()" value="Modify"> </td>
	</tr>
</table>

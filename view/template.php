				...
				<div class="modal-body">
					...
					<table id="modal_info">
						...
						<tr>
							...
							<td id="like"></td>
							<td id="like_img" onclick="<?php if (isset($_SESSION['login'])) echo "like()";
														else echo "notLog()"; ?>"><img id="like_img_2" src="./public/icons/like_on.png"></td>
							<td id="date"></td>
						</tr>
						<tr>
							<td colspan="3">
						...
						<tr>
							<td colspan="3"><input type="text" id="new_com" name="comment" placeholder="Add a comment"></td>
						</tr>
						<tr>
							<td><input style="opacity:0" type="submit" name="submit" id="submit" onclick="<?php if (isset($_SESSION['login'])) echo "comment()";
																											else echo "notLog()"; ?>" value="valid"></td>
						</tr>
					</table>
				</div>
			</div>

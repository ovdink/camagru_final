...
<table id="profile">
	<tr>
		...
		<td><input id="modify_profile" onclick="window.location.href='./modify_profile.php?page=1'" type="button" value="Изменить профиль"></td>
	</tr>
	<tr>
	...
	<tr>
		<td></td>
		<td colspan="2"><input id="modify_profile_2" onclick="window.location.href='./modify_profile.php?page=1'" type="button" value="Изменить профиль"></td>
	</tr>
</table>

...
if ($i == 0) {
	echo "<p style='color:red'>You don't have any fotos</p>";
} else {
	echo "</br><input onclick='modify_picture()' style='margin-left:60px; width:150px;' type='submit' name='submit' id='submit_form' value='Delete'>";
}
$picture->closeCursor();
?>
